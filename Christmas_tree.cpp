...
int main()
{
    ...
    cout<<"Wprowadz szerokosc choinki (liczba wieksza lub rowna 7, nieparzysta, dajaca reszte 1 przy dzieleniu przez 3):"<<endl; //warunki 1. >=7 - minimalna wielkosc drzewka wynosi 7; 2. nieparzystosc konieczna aby po srodku znajdowala sie pierwsza gwiazdka; 3. reszta z dzielenia aby choinka zachowala‚a swoj ksztalt
    cin>>n;
    cout<<endl;
